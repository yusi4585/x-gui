...
// @downloadURL https://gitlab.com/CidCaribou/x-gui/-/raw/main/x-gui.user.js?ref_type=heads
// @updateURL   https://gitlab.com/CidCaribou/x-gui/-/raw/main/x-gui.user.js?ref_type=heads
